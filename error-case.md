...
### D5. 🔴 build_report ReportSchema 미정의 block type 환각 (`metric_group`)
...
### D6. 🔴 build_report LLM JSON에 invalid escape — JSONDecodeError
...
### D7. 🔴🔴 한글 가드 false positive — CASE WHEN 안 한글 string literal 차단 (16턴 연속 트랩 확인)
...
### D7-수반. 🔴 가드 에러 메시지가 LLM에 잘못된 진단을 주입 (self-correction 트랩)
...
### E1. 🔴 system_base.md TOP N 강제 규칙 부재
...
### E7. 🔴🔴 한글 컬럼 사전 금지 규칙 부재 (proactive guidance gap)
