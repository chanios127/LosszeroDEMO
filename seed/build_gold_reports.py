            ...
            "data_refs": [
                {
                    ...
                    "rows": [
                        ...
                        {"사용자명": "채선희", "출근시각": "08:00", "퇴근시각": "17:30", "팀": "디자인"},
                    ],
                },
                {
                    "id": 1,
...
def build_attendance_trend_30d() -> dict:
    ...
    return {
        ...
        "domain": "groupware",
        "tags": ["근태", "정시율", "30일", "추이"],
        "summary": "30일 평균 정시율 93.2%. 4/15~17 피크(96%) 후 4/20~21 일시 하락(-3.4pp). 최우수 채선희 100%, 최저 박창권 76%.",
        ...
        "schema": {
            ...
            "data_refs": [
                ...
                },
                {
                    ...
                    "rows": [
                        {"사용자명": "채선희", "정시율표시": "100%", "평균출근시각": "08:02", "팀": "디자인"},
